...
export const THIRD_ISLAND_8 = CONFIG.CLAIM_NONWEB3_SHOW_DISCLAIMER.material ? "Before you go, take this wearable as thanks for your help." : "Thanks for your help."
...
export const THIRD_ISLAND_11 = CONFIG.CLAIM_NONWEB3_SHOW_DISCLAIMER.material ? "Oh! You forgot your wearable." : "With the materials that you gave me, I can create awesome wearables. Thanks!" 

// Dialogs  Kit island
export const FOURTH_ISLAND_0 = "Hi I’m Kit. You’re just about ready to visit the main part of Decentraland: Genesis City!"
export const FOURTH_ISLAND_1 = "Genesis City is a huge open world, and every part of it is <b>owned</b> by someone in the community."
export const FOURTH_ISLAND_2 = "You can get there through these <b>portals.</b> Looks like they aren’t working right now. Maybe if you restore the power they will start working again."
...
export const PORTAL_ISLAND_4 = CONFIG.CLAIM_NONWEB3_SHOW_DISCLAIMER.puzzle ? "Before you go, don't forget your reward for activating the portals" : "Thanks again for activating the portals!"
